...
- [ ] **الفجوة 5: البنية التحتية والمحتوى المزود من الكنيسة (User-Supplied Inputs)** — تطبيق هجرات Supabase الـ 11، النطاق الرسمي، شهادة SSL، واعتماد الكنيسة للبيانات الرسمية (الحسابات، الكهنة، الهواتف، المواعيد). *الافتراض الآمن*: بقاء بيانات البذرة الموسومة والعمل على المحرك الملفي المدعوم.
