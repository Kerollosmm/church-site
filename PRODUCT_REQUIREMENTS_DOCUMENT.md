...
#### 3.2.2 دليل الأطباء وساعات العيادات (`/clinics/doctors`)
- بطاقة الطبيب:
  - الصورة الشخصية المهنية.
  - الاسم الكامل واللقب العلمي (استشاري / أخصائي / زميل الكلية الملكية / ماجستير / دكتوراه).
  - التخصص الدقيق (مثل: جراحة يد وأوتار، سكر وغدد صماء، حساسية وصدر أطفال).
  - جدول مواعيد العيادة بالأيام والساعات بدقة متناهية (مثال: الإثنين والأربعاء من 6:00 م حتى 9:00 م).
  - رقم الغرفة أو العيادة داخل مبنى الخدمات.
  - طريقة الحجز (حجز بأسبقية الحضور / حجز مسبق عبر شباك التذاكر).

#### 3.2.3 نظام نبض العيادات والاعتذارات اللحظية (`/clinics/status` أو شريط التنبيهات)
- **أهم ميزة تشغيلية**:
