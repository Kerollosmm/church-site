...
export default function HistoryPage() {
  const milestones = [
    ...
    {
      year: "2000",
      title: "إنشاء مبنى الخدمات والمستوصف الخيري",
      desc: "افتتاح الصرح الخدمي متعدد الطوابق الذي يضم المستوصف الطبي، قاعة العزاء، المركز التعليمي، والحضانة النموذجية لخدمة مجتمع شرق الإسكندرية.",
    },
    {
      year: "2024",
      title: "تطوير المنظومة الرقمية والتحديث الشامل",
      desc: "تحديث وتطوير كافة العيادات التخصصية وإطلاق البوابة الرقمية التفاعلية لخدمة شعب الكنيسة وتسهيل الوصول للقداسات والخدمات دون عوائق.",
    },
  ];
