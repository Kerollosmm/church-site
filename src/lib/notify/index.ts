...
import type { SubscriberRecord } from "@/lib/domain/types";
import { getMailer, type MailMessage, type MailSendResult } from "@/lib/notify/mailer";
import { recordWouldSendNote } from "@/lib/notify/noop-mailer";

export * from "@/lib/notify/mailer";
