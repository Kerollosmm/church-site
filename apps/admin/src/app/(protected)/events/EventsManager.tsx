...
export function EventsManager({ events, series, capabilities, locale }: EventsManagerProps): React.ReactElement {
  ...
  function eventActions(row: AdminEventRow): React.ReactNode {
    ...
    return (
      <div className="flex flex-wrap items-center gap-1.5">
        {capabilities.update ? (
          <Link href={`/events/${id}/edit`} className={ADMIN_BUTTON_QUIET}>
  ...
  function seriesActions(row: AdminSeriesRow): React.ReactNode {
    ...
    return (
      <div className="flex flex-wrap items-center gap-1.5">
        <Link href={`/events/series/${id}`} className={ADMIN_BUTTON_QUIET}>
          <Pencil aria-hidden="true" className="h-3.5 w-3.5" />
    ...
    <div className="space-y-6">
      ...
      <section aria-labelledby="events-list-heading" className={ADMIN_PANEL}>
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          {capabilities.create ? (
            <Link href="/events/new" className={ADMIN_BUTTON_PRIMARY}>
        ...
        {events.length === 0 ? (
          <div className="mt-4 rounded-2xl border border-dashed border-copticGold-300 bg-copticGold-50/40 p-8 text-center">
            ...
            {capabilities.create ? (
              <Link href="/events/new" className={`mt-4 ${ADMIN_BUTTON_PRIMARY}`}>
                <Plus aria-hidden="true" className="h-4 w-4" />
                        ...
                        <div className="flex flex-wrap items-center gap-1.5">
                          {row.isOverride ? (
                            <>
                              ...
                              <Link
                                href={`/events/series/${row.event.seriesId}`}
      ...
      <section aria-labelledby="series-list-heading" className={ADMIN_PANEL}>
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          {capabilities.seriesWrite ? (
            <Link href="/events/series/new" className={ADMIN_BUTTON_SECONDARY}>
              <Plus aria-hidden="true" className="h-4 w-4" />
        ...
        {series.length === 0 ? (
          <div className="mt-4 rounded-2xl border border-dashed border-copticGold-300 bg-copticGold-50/40 p-8 text-center">
            ...
            {capabilities.seriesWrite ? (
              <Link href="/events/series/new" className={`mt-4 ${ADMIN_BUTTON_SECONDARY}`}>
                <Plus aria-hidden="true" className="h-4 w-4" />
